...
$JAVABIN/java -Xmx1024M -Djava.library.path="$INSTALLDIR/lib" -Dhdfview.root="$INSTALLDIR" -jar "$INSTALLDIR/../Java/jhdfview.jar" $*

# alternate invocation when using modules
#$JAVABIN/java -Xmx1024M -Djava.library.path="$INSTALLDIR/lib:$INSTALLDIR/lib/ext" -Dhdfview.root="$INSTALLDIR" -cp "$INSTALLDIR/../Java/jhdfview.jar" ncsa.hdf.view.HDFView $*
