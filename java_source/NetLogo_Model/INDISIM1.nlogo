...
;               INDISIM1.logo                 ;
;                                             ;
;   WARNING: designed to work with INDISIM1   ;
;   java program. If using without java,      ;
;   uncomment the open/close commands in main ;
;   "go" loop.                                ;
;                                             ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
turtles-own [ mass start_mass energy viab ]      ; "turtles-own" - defines the variables belonging to each turtle.
...
to setup
  clear-all                              ; code for clearing any previous "runs" of the code present in the NetLogo window
  random-seed 1111
...
to write-to-file
  if ticks <= 2000 [file-print ( word " " ticks  word "  " count turtles word " " ( [mass] of turtles) )]
  ;file-print ""
end
@#$#@#$#@
GRAPHICS-WINDOW
